...
export default function DocumentationPage() {
  ...
  const navItemClass = (id: string) => `flex items-center text-sm px-3 py-2 rounded-md transition ${
    activeSection === id 
      ? 'text-blue-400 bg-slate-800/80 font-medium shadow-sm' 
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row relative">
        ...
        <main className="flex-1 py-10 md:pl-10 md:max-w-4xl prose prose-invert prose-slate prose-pre:bg-slate-900 prose-pre:border prose-pre:border-slate-800">
          ...
          <section id="quickstart" className="scroll-mt-32 mb-20">
            ...
            <div className="space-y-6">
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-3 flex items-center"><span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600/20 text-blue-400 text-sm mr-3">1</span> Install the Application</h3>
                <p className="text-slate-400 mb-4 text-sm">Hushh Tunnel is distributed via Python's package manager. Install it easily using pip.</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-3 flex items-center"><span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600/20 text-blue-400 text-sm mr-3">2</span> Log in to your Account</h3>
                <p className="text-slate-400 mb-4 text-sm">Authenticate your device to securely link it with your account.</p>
                <div className="bg-slate-950 p-4 rounded-lg font-mono text-sm text-slate-300 border border-slate-800/50 shadow-inner">
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-3 flex items-center"><span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600/20 text-blue-400 text-sm mr-3">3</span> Expose your Local Service</h3>
                <p className="text-slate-400 mb-4 text-sm">Pass the port number where your local application is running to instantly create a public URL.</p>
                <div className="bg-slate-950 p-4 rounded-lg font-mono text-sm text-slate-300 border border-slate-800/50 shadow-inner">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="bg-slate-900/40 border-slate-800/80">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-slate-400">We automatically provision TLS certificates so your traffic is encrypted end-to-end.</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-900/40 border-slate-800/80">
                <CardContent className="pt-6">
                  <Activity className="w-6 h-6 text-blue-400 mb-3" />
                  <h4 className="font-semibold text-white mb-2">Instant & Reliable</h4>
                  <p className="text-sm text-slate-400">Connections are established instantly with auto-reconnects built in to handle network drops.</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-900/40 border-slate-800/80">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-slate-400">Your connections are securely linked to your account, ensuring only you control your tunnels.</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-900/40 border-slate-800/80">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-slate-400">Use easily identifiable, custom URLs to share your work professionally.</p>
                </CardContent>
              </Card>
            </div>
          </section>
          ...
          <section id="examples" className="scroll-mt-32 mb-20">
            <h2 className="text-3xl font-bold mb-6 border-b border-slate-800 pb-2">Use Case Examples</h2>
            
            <div className="mb-8">
              <h3 className="text-xl font-semibold mb-3 text-white">Sharing a Web Application Demo</h3>
              <p className="text-slate-400 mb-3">If you are running a React, Vue, or Next.js app on port 3000 and want to share it with a client:</p>
              ...
              <p className="text-slate-400 mt-3 text-sm italic">You can now send the `https://[id].hushh.online` link directly to your client. They can view it in their browser instantly.</p>
            </div>

            <div className="mb-8">
              <h3 className="text-xl font-semibold mb-3 text-white">Testing Webhooks Locally</h3>
              <p className="text-slate-400 mb-3">When testing integrations from services like Stripe, GitHub, or Twilio, they need a public URL to send events to. Simply expose your local backend server (e.g., port 8000):</p>
              <div className="bg-slate-950 p-4 rounded-lg font-mono text-sm text-slate-300 border border-slate-800">
                <span className="text-slate-500">$ </span>python manage.py runserver 8000<br />
                <span className="text-slate-500">$ </span>hushh http 8000
              </div>
              <p className="text-slate-400 mt-3 text-sm italic">Copy your tunnel URL and paste it into the webhook configuration of Stripe/GitHub. All events will route directly to your local code.</p>
            </div>
          </section>

          <section id="custom-subdomains" className="scroll-mt-32 mb-20">
            <h2 className="text-3xl font-bold mb-6 border-b border-slate-800 pb-2">Using Custom Subdomains</h2>
            ...
            <div className="bg-slate-950 p-4 rounded-lg font-mono text-sm text-slate-300 border border-slate-800 mb-4">
              <span className="text-slate-500">$ </span>hushh http 8080 --subdomain my-awesome-app
              <br /><br />
              <span className="text-emerald-400">✔ Connected</span><br />
              <span className="text-blue-400">https://my-awesome-app.hushh.online</span> <span className="text-slate-500">→</span> http://localhost:8080
            </div>
